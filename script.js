...
let questions = [
  ...
  {
    numb: 4,
    question: "How do you terminate a C statement?",
    answer: ";",
    options: [
      ";",
      ":",
  ...
  },
  {
    ...
    answer: "const",
    options: ["const", "constant", "define", "var"],
  },
  {
    numb: 7,
  ...
  },
  {
    ...
    options: ["Exits the loop", "Skips the current iteration", "Jumps to a specified label", "Terminates the program"],
  },
  {
    numb: 10,
    question: "What is the role of the return() statement in a C function?",
